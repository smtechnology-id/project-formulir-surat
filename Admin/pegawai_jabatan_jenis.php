...
$sql = mysqli_query($conn, "Select * from tb_jabatan_jenis");
?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Tabel Data Jenis Jabatan Pegawai</h4>
                                        <a href="pegawai_input_jabatan_jenis.php" class="btn btn-primary btn-sm my-2">Input Jenis Jabatan</a>

                                        <table id="tablePegawai" class="table mb-0" id="my-table">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Id Jabatan Jenis</th>
                                                    <th>Jabatan Jenis</th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($fetch_jabatan_jenis = mysqli_fetch_array($sql)) {

                                                ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo $fetch_jabatan_jenis['id_jabatan_jenis'] ?></td>
                                                        <td><?php echo $fetch_jabatan_jenis['jabatan_jenis'] ?></td>
                                                        <td>
                                                            <a href="pegawai_edit_pangkat_gol.php?id_pegawai=<?php echo $fetch_jabatan_jenis['id_jabatan_jenis'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                                            <a href="pegawai_hapus_pangkat_gol.php?id_pegawai=<?php echo $fetch_jabatan_jenis['id_jabatan_jenis'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash">
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $no++;
