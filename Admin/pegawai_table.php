                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="pegawai_input.php" class="btn btn-primary btn-sm my-2">Input Pegawai</a>

                                        <table id="pegawaiTable" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Position</th>
                                        ...
                                        <!-- <table id="tablePegawai" class="table mb-0" id="my-table">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($fetch_pegawai = mysqli_fetch_array($sql)) {

                                                ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        <td><?php echo $fetch_pegawai['id_pegawai'] ?></td>
                                                        <td><?php echo $fetch_pegawai['tempat_lahir'] ?></td>
                                                        <td><?php echo $fetch_pegawai['tgl_lahir'] ?></td>
                                                        <td><?php echo $fetch_pegawai['nama_pegawai'] ?></td>

                                                        <?php
                                                        $id_pangkat_golongan = $fetch_pegawai['id_pangkat_gol'];
                                                        $sql_pangkat_gol = mysqli_query($conn, "SELECT * FROM tb_pangkat_golongan where id_pangkat_golongan = $id_pangkat_golongan ");
                                                        $fetch_pangkat_gol = mysqli_fetch_array($sql_pangkat_gol);
                                                        ?>

                                                        <td><?php echo $fetch_pangkat_gol['pangkat'] ?> / <?php echo $fetch_pangkat_gol['golongan'] ?>-<?php echo $fetch_pangkat_gol['ruang'] ?> </td>
                                                        <?php
                                                        ...
                                                        if ($fetch_jabatan != '') {
                                                        ?><td><?php echo $fetch_jabatan['jabatan_nama'] ?></td><?php
                                                                                                            } else {
                                                                                                                ?>
                                                            <td>-</td>
                                                        <?php
                                                        ...
                                                        <?php
                                                        $id_bidang = $fetch_pegawai['id_bidang'];
                                                        $sql_bidang = mysqli_query($conn, "SELECT * from tb_bidang where id_bidang = $id_bidang");
                                                        $fetch_bidang  = mysqli_fetch_array($sql_bidang);
                                                        ?>

                                                        <td><?php echo $fetch_bidang['nama_bidang'] ?></td>
                                                        <td>
                                                            <a href="pegawai_edit.php?id_pegawai=<?php echo $fetch_pegawai['id'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                                            <a href="pegawai_hapus.php?id_pegawai=<?php echo $fetch_pegawai['id'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash">
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $no++;
