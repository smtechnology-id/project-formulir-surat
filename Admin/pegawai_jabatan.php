                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">Data Jabatan Pegawai</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Tabel Data Jabatan Pegawai</h4>
                                        <a href="pegawai_jabatan_pegawai.php" class="btn btn-primary btn-sm my-2">Input Jabatan Pegawai</a>
                                        ...
                                        <table id="tablePegawai" class="table mb-0" id="my-table">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($fetch_jabatan = mysqli_fetch_array($sql)) {

                                                ?>
                                                    <tr>
                                                        <td><?php echo $fetch_jabatan['id_jabatan_jenis'] ?></td>
                                                        <td><?php echo $fetch_jabatan['jabatan_nama'] ?></td>
                                                        <td>
                                                            <a href="pegawai_edit_jabatan.php?id_pegawai=<?php echo $fetch_jabatan['id_jabatan'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                                            <a href="pegawai_hapus_jabatan.php?id_pegawai=<?php echo $fetch_jabatan['id_jabatan'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash">
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $no++;
